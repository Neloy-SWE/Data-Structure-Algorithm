...
namespace Data_Structure___Algorithm.Structures.StructureQueue.Priority.Descending
{
    internal class DescendingPriorityQueue
    {
        private Element[] elements;
        private int currentIndex;
        private int size;

        public DescendingPriorityQueue(int size)
        {
            Console.WriteLine(":::: Descending Priority Queue ::::\n\n");
